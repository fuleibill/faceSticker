...
@interface MSGPUImageMovieWriter ()
{
...
@implementation MSGPUImageMovieWriter
{
...
//    NSLog(@"###############");
    ...
    @synchronized(self)
    {
        ...
        if (self.delegate && [self.delegate respondsToSelector:@selector(processMagicStickerSampleBuffer:)])
        {
            [self.delegate processMagicStickerSampleBuffer:sbufCurrentFrame];
        }
    }
